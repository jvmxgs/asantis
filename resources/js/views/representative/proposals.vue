        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col col-xs-6">
                    <h3 class="panel-title">Propuestas sin atender</h3>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Propuesta</th>
                        <th colspan="1" class="text-center">Núm. de viaje</th>
                ...
                <tbody>
                    <template v-for="(proposal, index) in proposals">
                        <tr class="proposalrow">
                            ...
                            <td align="center">
                                <router-link :to="{name: 'freights', params: {freightnumber: proposal.freight.freightnumber}}" class="btn btn-success"> <em class="fa fa-comment-dots"></em></router-link>
                            </td>
                        </tr>
                    </template>
                </tbody>
...
<script>
    export default {
        ...
        mounted() {
            axios.get('/proposals/unattended').then((response) =>{
